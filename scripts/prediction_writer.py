...
#prediction_writer("../data/clean_test_data.csv", "../data/weights/logistic_regression_weights.csv", "../data/predictions/logistic_regression_predictions.csv")
#prediction_writer("../data/clean_test_data.csv", "../data/weights/reg_logistic_regression_weights.csv", "../data/predictions/reg_logistic_regression_weights.csv")
prediction_writer("../data/clean_test_data.csv", "../data/weights/ridge_reg.csv", "../data/weights/ridge_reg_prediction.csv")
